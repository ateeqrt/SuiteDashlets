...
(function ($) {
	...
	var _colorpicker_index = 0,
		...
		_container_inline = '<div class="ui-colorpicker ui-colorpicker-inline ui-dialog ui-widgetui-widget-content ui-corner-all"></div>',
	...
	$.widget("vanderlee.colorpicker", {
		options: {
			...
			buttonImage:		'modules/rt_maps/tpls/images/ui-colorpicker.png',
		...
		open: function() {
			...
			if (!that.opened) {
				...
				that.dialog.css('z-index', zIndex += 1000);
