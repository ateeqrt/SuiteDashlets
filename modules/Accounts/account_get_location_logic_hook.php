...
class acc_get_location_logic_hook {
    ...
    function get_location(&$bean, $event, $arguments) {
        ...
        if (!empty($row->maps_lat) && !empty($row->maps_long)) {
            $bean->location_marker2 = '<a title="Location on map" id="location_marker" href="index.php?module=rt_maps&offset=1&from_module=Account&return_module=Accounts&action=googlemaps&record=' . $id . '"><img src="custom/include/maps_images/redpin.jpg" border="0" alt="location"></a>';
        } else {
